...
Function **imPlotImputed** plots the densities of the imputed outcomes and the
...
Function **imPlotComposite** generates the treatment-specific cumulative
...
effect and quantiles of the composite endpoint using function **imEstimate**:
